...
export type TestCaseSection =
  | "pre_conditions"
  | "steps"
  | "expected_outcomes";

/* ======================================================
   TEST CASE BUILDER HOOK
====================================================== */

export function useTestCaseBuilder(testCaseId: number) {
  /* ======================================================
     CORE STATE
  ====================================================== */
  ...
  const [sections, setSections] = useState<
    Record<TestCaseSection, FlowStep[]>
  >({
    pre_conditions: [],
    steps: [],
    expected_outcomes: [],
  ...
  const [activeSection, setActiveSection] =
    useState<TestCaseSection>("steps");
  ...
  const [dirtySections, setDirtySections] =
    useState<Record<TestCaseSection, boolean>>({
  ...
  function markDirty(section: TestCaseSection) {
