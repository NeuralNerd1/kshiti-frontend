...
import LocalTestCaseActionsMenu from "./LocalTestCaseActionsMenu";

type LocalTestCaseCardProps = {
    testCase: {
        id: number;
        name: string;
        description?: string;
...
export default function LocalTestCaseCard({
    testCase,
    onOpen,
    onEdit,
    onArchive,
}: LocalTestCaseCardProps) {
